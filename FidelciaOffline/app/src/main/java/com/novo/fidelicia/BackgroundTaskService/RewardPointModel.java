...
public class RewardPointModel {
    int reward_id,member_id;
    String points_gained,comment,created_by,created_on,updated_by,updated_on,reward_type,cashier_id,card_number;
    ...
    public void setPoints_gained(String points_gained) {
